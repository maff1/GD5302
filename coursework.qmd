...
## Dataset
1. Genotype data (Plink format with three files: `.bed`, `.bim`, `.fam`) from the [1000 genomes](https://www.internationalgenome.org/category/phase-3/) phase 3 project. Available at the path `/scratch/bioinf/gd5302/coursework/student_datasets/USERNAME`.
